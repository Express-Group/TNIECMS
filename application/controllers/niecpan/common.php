		...
		try
		{
			...
			if (isset($ImageDetails['image_name']))
			{
				$image_src_path= '';
					...
					break;
					case "image_1200_800":
							$dst 		= $image_src_path. str_replace(".","_1200_800.",$ImageDetails['image_name']);
							$source = $source.str_replace(".","_1200_800.",$ImageDetails['image_name']);
					break;
				...
				if (!empty($src) && !empty($dst) && !empty($data))
				{
					...
					break; 
					case "image_1200_800":
							update_temp_images( $content_id, $crop_caption, $crop_alt,$Null_value,$Null_value,$Null_value,2, $modifiedon, $crop_image_id,'image_1200_800',0,1);
