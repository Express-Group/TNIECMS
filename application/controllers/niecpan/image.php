				...
				$data['Menu_id']	= get_menu_details_by_menu_name('Image Library');
					...
					if(defined("USERACCESS_ADD".$data['Menu_id']) && constant("USERACCESS_ADD".$data['Menu_id']) == 1) {
						...
						if(isset($viewimage['image_name'])) {
							...
							$Tempdata['image_binary_file1200X800']		=  image_url.$data['image_path'].$Image1200X800;
							...
							$Tempdata['imgtype900X450']		= $viewimage['image4_type'];
							$Tempdata['imgtype1200X800']	= $viewimage['image4_type'];
