...
<style>
.CommentPopup textarea{height: 130px;width: 290px;}
@media only screen and (min-width: 1551px){
	.CommentPopup textarea{width: 500px;}
}
</style>
<script>
$(document).ready(function()
		  ...
		  if(r==true)
		  {
			  ...
			  { 
				  ...
				  success: function(data) 
				  {
					  ...
					  {
						 // comment_datatables();
							$(current_index).parent().prev().find('span').attr('title','Approved').html('<i class="fa fa-check"></i>');
							$(current_index).parent().prev().find('a').attr('title','Approved').html('<i class="fa fa-check"></i>');
							$(current_index).parents('tr').remove();
							if($('#example').find('tbody').html()==''){
								comment_datatables();
							}
		  ...
		  if(r==true)
		  {
			  ...
			  { 
				  ...
				  success: function(data) 
				  {
					  ...
					  {
						  //comment_datatables();
						  $(current_index).parent().prev().find('span').attr('title','Rejected').html('<i class="fa fa-times"></i>');
						  $(current_index).parent().prev().find('a').attr('title','Rejected').html('<i class="fa fa-times"></i>');
						  $(current_index).parents('tr').remove();
						  if($('#example').find('tbody').html()==''){
								comment_datatables();
						  }
