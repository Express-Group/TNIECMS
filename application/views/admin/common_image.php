    ...
    <div class="Overflow DropDownWrapper">
	 ...
	 <p>Select size to be used  for resizing original image</P>
	   <div class="CroppingSize">
			 <input type="checkbox" name="image_resize" id="image_resize_id" class="WidthAuto margin-right-10" value="image_1200_800" <?php if($last_crop_image['imgtype1200X800'] != 2) { echo "checked"; } ?> /> <label>1200px X 800px</label>
        ...
        <ul class="tabs GalleryTabs" >
		 <li class="selected"><a href="#view6" >1200px X 800px</a></li> 
		 <li><a href="#view5" >900px X 450px</a></li> 
        <li><a href="#view1" >600px X 390px</a></li> 
		<?php if($this->uri->segment(2) != 'gallery_image_processing') { ?>
		...
		<section class="GalleryTabsContent">
			...
			<div id="view6" style="display:block;">
			 <div class="AutoCropper">
				<img id="resize_image_content"  style="width:1200px;height:800px;" <?php if(!isset($last_crop_image['image_binary_file1200X800']) || $last_crop_image['image_binary_file1200X800'] == '' || $last_crop_image['image_binary_file1200X800'] == 'NULL') { ?> style="display:none;" <?php } ?> src="<?php if(isset($last_crop_image['image_binary_file1200X800'])) { echo $last_crop_image['image_binary_file1200X800']; } ?>"  />
				</div>
			</div>
          ...
          <div align="center" style="display:none;" id="loadingdragimage"><img src="<?php echo base_url();?>images/loadingimage.gif" style="border:none; width:30px; height:30px;" /><br />
           ...
           <div class="CropperWrapper" id="crop_container" <?php if(isset($last_crop_image['imgsrc']) && $last_crop_image['imgsrc'] != '') {} else{ ?> style="display:none;" <?php } ?>>
            ...
            <div class="CroppingSize">
			<input type="radio" name="image_type" id="image_type_id" class="WidthAuto margin-right-10" value="image_1200_800" checked /> <label>1200px X 800px</label>
			 <input type="radio" name="image_type" id="image_type_id" class="WidthAuto" value="image_900_450"  /> <label>900px X 450px</label>
			 <input type="radio" name="image_type" id="image_type_id" class="WidthAuto" value="image_600_390"  /> <label>600px X 390px</label>
			<?php if($this->uri->segment(2) != 'gallery_image_processing') { ?>
        ...
        <div class="img-container">
         <img id="crop_image_src" src="<?php echo $last_crop_image['imgsrc'];?>"  class="rotatecontrol"  border="0"   />
				...
				<figure class="GalleryImageSize1">
                      <p>Size : 1200px X 800px</p>	
                     <img id="image_1200_800" class="MainImage1" <?php if(!isset($last_crop_image['image_binary_file1200X800']) || $last_crop_image['image_binary_file1200X800'] == '' || $last_crop_image['image_binary_file1200X800'] == 'NULL') { ?> style="display:none;" <?php } ?> src="<?php if(isset($last_crop_image['image_binary_file1200X800'])) { echo $last_crop_image['image_binary_file1200X800']; } ?>" >	
                </figure>
				<figure class="GalleryImageSize1">
