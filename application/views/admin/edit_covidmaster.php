	...
	<div class="BodyWhiteBG">
		<div class="BodyHeadBg Overflow clear">
			<div class="FloatLeft  BreadCrumbsWrapper PollResult">
				<div class="breadcrumbs"><a href="#">Dashboard</a> > <a href="#">Edit Hospital</a></div>
					<h2>Edit Hospital</h2>
			</div> 
					...
					<div class="row" style="margin-top: 15px;width: 100%;">
							...
							<div class="form-group">
								...
								<select name="states" class="form-control">
									...
									foreach($states as $state):
										echo '<option '.(($state->State_Id==$data['stateId'])? ' selected ' :'').' value="'.$state->State_Id.'">'.$state->StateName.'</option>';
									endforeach;
									?>
								</select>
							...
							<div class="form-group">
								...
								<select name="cities" class="form-control">
									...
									foreach($cities as $city):
										echo '<option '.(($city->City_id==$data['cityId'])? ' selected ' :'').' value="'.$city->City_id.'">'.$city->CityName.'</option>';
									endforeach;
									?>
								</select>
						...
						<div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
							<div class="form-group">
								...
								<input type="text" name="centre" class="form-control" value="<?php echo $data['centre'];?>">
						...
						<div class="col-md-5 col-lg-5 col-sm-12 col-xs-12">
							...
							<div class="form-group">
								...
								<input type="text" name="contact_number" class="form-control" value="<?php echo $data['contact_number'];?>">
								<?php echo form_error('contact_number', '<p class="error">', '</p>'); ?>
							</div>
							<div class="form-group">
								<label class="checkbox-inline">
									<input <?php if(in_array('1' , $types)){ echo ' checked ';} ?> name="type[]" type="checkbox" value="1">Hospital (normal beds)
								</label>
								<label class="checkbox-inline">
									<input <?php if(in_array('2' , $types)){ echo ' checked ';} ?> name="type[]" type="checkbox" value="2">Hospital bed (oxygen beds)
								</label>
								<label class="checkbox-inline">
									<input <?php if(in_array('3' , $types)){ echo ' checked ';} ?> name="type[]" type="checkbox" value="3">Hospital bed (ICU beds)
								</label>
								<label class="checkbox-inline">
									<input <?php if(in_array('4' , $types)){ echo ' checked ';} ?> name="type[]" type="checkbox" value="4">Ventilator
								</label>
