...
$show_simple_tab .= '<div class="row">
            ...
            <div class="business section-article-states" ' . $widget_bg_color . '>
...
//$leadstory        = $this->widget_model->get_sub_sec_lead_stories_data($main_sction_id, $get_widget_instance['Page_type'], $get_widget_instance['WidgetDisplayOrder'], $subsection_widgetID['widgetId'], $main_sction_id, $live_version, $view_mode);
	...
	if(count($widget_contents) > 0)
	{
		...
		foreach($widget_contents as $get_content)
		{
			...
			else
			{
				...
				$show_simple_tab .= '<p> <i></i> ' . $display_title . '</p>';
