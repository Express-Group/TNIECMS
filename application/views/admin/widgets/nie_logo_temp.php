...
<div class="row">
	...
	<div class="MobileInput"> 
		<form class="" action="<?php echo base_url(); ?>topic"  name="SimpleSearchForm" id="mobileSearchForm" method="get" role="form">
			<input type="text" placeholder="Search..." name="search_term" id="mobile_srch_term" value="<?php echo $search_term;?>"/> <a href="javascript:void(0);" id="mobile_search"><img src="<?php echo image_url; ?>images/FrontEnd/images/search-mob.png" /></a>
		</form>
	</div>
		...
		<div class="social_icons SocialCenter mobile-share">
			<div class="dropdown menucat">
				 ...
				 <ul class="dropdown-menu">
					...
					<li class="all-menu-sub"><a href="<?php echo base_url('business/union-budget'); ?>"><?php echo "Budget 2019"; ?></a></li>
					<li class="dropdown-submenu all-menu">
	...
	<div class="col-lg-8 col-md-8 col-sm-8 col-xs-7">
		<div class="main_logo">
		  <?php 
			echo '<a href="'.base_url().'"><img src="'.image_url.'images/FrontEnd/images/new_logo.jpg"></a>';
		  ?>
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				...
				<div class="large-screen-search">
					<div class="social-icons-wrapper margin-bottom-10">
						...
						<a class="social-icon-set" href="<?php echo $header_details['rss_url'];?>" rel="nofollow" target="_blank"><img src="<?php echo image_url ?>/images/FrontEnd/images/social-icon-set/Fb_new.png"></a>
						
						<a href="https://www.youtube.com/user/thenewindianxpress" target="_blank" class="social-icon-set social-icon-set-youtube"><img src="<?php echo image_url ?>/images/FrontEnd/images/social-icon-set/twitter_new.png"></a>
						
						<a class="social-icon-set social-icon-set-fb" href="<?php echo $header_details['facebook_url'];?>" rel="nofollow" target="_blank"><img src="<?php echo image_url ?>/images/FrontEnd/images/social-icon-set/G_plus_new.png"></a>
						
						<a class="social-icon-set" href="<?php echo $header_details['google_plus_url'];?>" rel="nofollow" target="_blank"><img src="<?php echo image_url ?>/images/FrontEnd/images/social-icon-set/Insta_new.png"></a>
						
						<a class="social-icon-set" href="<?php echo $header_details['twitter_url'];?>" rel="nofollow" target="_blank"><img src="<?php echo image_url ?>/images/FrontEnd/images/social-icon-set/YT_new.png"></a>
						
						<a class="social-icon-set" href="https://instagram.com/newindianexpress/" target="_blank"><img src="<?php echo image_url ?>/images/FrontEnd/images/social-icon-set/rss_new.png"></a>
