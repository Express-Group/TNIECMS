...
if($get_content_ids!='')
{
	...
	{	
		...
		foreach($widget_contents as $get_content)
		{
			...
			if($i==1){
				$show_simple_tab.= '<div style="float: left;width: 100%;padding-bottom: 7px;border-bottom: 1px solid #ccc;"><div class="col-md-5" style="padding:0;padding-right: 5px;"><img src="'.$dummy_image.'" data-src="'.$show_image.'" title = "'.$imagetitle.'" alt = "'.$imagealt.'"></div>
				<div class="col-md-7" style="padding:0;"><h4 style="padding: 0px 0 12px;border:none;">'.$display_title.'</h4></div></div>';
			}
			else{
				$show_simple_tab.= '<p class="pull-left"><i class="fa fa-angle-right"></i>'.$display_title.'</p>';
			}	
			$i =$i+1;	
		}
