...
$show_simple_tab.=	'<div class="MagazinesVoiceItem"><span class="VoiceContTopic"><a href="'.$url_section_value.'" >'.$author_name.'</a></span><div class="MagazinesVoiceImg"><a  href="'.$live_article_url.'" class="article_click"  ><img  src="'.$show_image.'"  title = "'.$imagetitle.'" alt = "'.$imagealt.'"></a></div><div class="MagazinesVoiceCont"><p> '.$display_title.'
</p></div></div>';
