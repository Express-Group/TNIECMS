		 ...
		 {	
				foreach($widget_contents as $get_content)
				{
					...
					$show_image="";
						...
						$author_name = str_replace('&nbsp;', ' ', htmlentities($author_name));
						$author_name = html_entity_decode($author_name);
						$url_section_value	=	BASEURL.'Author/'. str_replace("'",'-',join("-", explode(" ", $author_name)));
						$url_section_value .='/'.$authorId;
						}
						//$url_section_value = BASEURL.'Author/'. str_replace("'",'-',join("-", explode(" ", $author_name)));
							//if($author_id!=''){
							//	$url_section_value .='/'.$author_id;
							//}
					...
					//  Assign article links block ends hers
						...
						$show_simple_tab.='<div class="most1">';
								...
								$show_simple_tab .='<a  href="'.$live_article_url.'" class="article_click" ><img width="150" height="150" src="'.$dummy_image.'" data-src="'.$show_image.'" title = "'.$imagetitle.'" alt = "'.$imagealt.'"></a>';
