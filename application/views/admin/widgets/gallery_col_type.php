...
{	
	foreach($widget_contents as $get_content)
	{
		...
		<img width="25" height="20" data-src="'.$play_video_image.'" src="'.image_url.'images/FrontEnd/images/lazy.png" class="GalleryIcon">
		</figure>
		...
		else
		{
			...
			<figure class="PositionRelative">';
			$show_simple_tab .='<a   href="'.$live_article_url.'" class="article_click" >';
			$show_simple_tab .='<img width="600" height="300" src="'.$dummy_image.'" data-src="'.$show_image.'" title = "'.$imagetitle.'" alt = "'.$imagealt.'"><img width="25" height="20" data-src="'.$play_video_image.'" src="'.image_url.'images/FrontEnd/images/lazy.png" class="GalleryIcon">
			</figure>
			<p>'.$display_title .'</p></a>
			</div>			
			</div>';	
