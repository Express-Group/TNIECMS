	...
	function delete_newsagency(id)
		{
			...
			if(r==true){
			window.location.href="<?php echo base_url() ?>niecpan/newsagency_manager/newsagency_delete/"+id;
		}
	}
</script>
<script>
	...
	$('#example').dataTable( 
{
    ...
    $('#example').dataTable( {
      ...
      if ($(this).find('tbody tr').length<=1) {
		...
		"ajax": {
            "url": "<?php echo base_url(); ?>niecpan/newsagency_manager/newsagency_datatable",
			"type" : "POST",
			"data" : {
