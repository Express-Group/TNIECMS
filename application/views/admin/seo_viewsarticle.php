        ...
        <p style="">Preview</p>
		  ...
		  <label>Caption :</label>
		   ...
		   <label>Image Name :</label>
            ...
            <div class="FloatLeft">
            <input id="count1" maxlength="100" readonly name="txtMetaTitle" type="text" value="<?php if(isset($get_article_details['MetaTitle'])) echo htmlentities($get_article_details['MetaTitle']); echo htmlentities(set_value('txtMetaTitle')); ?>" class="box-shad1"/>
			...
			<label>Meta Description</label>
             ...
             <textarea id="count2" maxlength="200"  readonly name="txtMetaDescription" class="article_textarea box-shad1"  ><?php if(isset($get_article_details['MetaDescription'])) echo htmlentities($get_article_details['MetaDescription']); echo htmlentities(set_value('txtMetaDescription')); ?></textarea>
...
<script type="text/javascript" src="<?php  echo image_url ?>includes/Tagedit-master/js/jquery.tagedit.js"></script>
	...
	var jqs = $.noConflict();
	jqs(function() {
	jqs("#agency_id").attr('disabled',true);
	jqs("#country_id").attr('disabled',true);
