...
function ImageLibraryCopyToTemp($ImageName,$NewImageName,$SourceURL, $DestinationURL) 
{
	...
	$Image950X450 	= str_replace("original","w950X450", $ImageName);	
	$Image1200X800 	= str_replace("original","w1200X800", $ImageName);	
	...
	$NewImage950X450 	= str_replace(".","_950_450.", $NewImageName);	
	$NewImage1200X800 	= str_replace(".","_1200_800.", $NewImageName);	
	  ...
	  //}
	   ...
	   if (file_exists(destination_base_path . $SourceURL . $Image100X65))
		...
		//}
		 ...
		 if (file_exists(destination_base_path . $SourceURL . $Image950X450))
		 copy(destination_base_path .$SourceURL . $Image950X450, source_base_path . $DestinationURL . $NewImage950X450);
		// ImageJPEG(ImageCreateFromString(file_get_contents( source_base_path . $DestinationURL . $NewImage150X150)), source_base_path . $DestinationURL . $NewImage150X150, 45);
		//}
		 if (file_exists(destination_base_path . $SourceURL . $Image1200X800))
		 copy(destination_base_path .$SourceURL . $Image1200X800, source_base_path . $DestinationURL . $NewImage1200X800);
		// ImageJPEG(ImageCreateFromString(file_get_contents( source_base_path . $DestinationURL . $NewImage150X150)), source_base_path . $DestinationURL . $NewImage150X150, 45);
		//}
...
function ImageDeleteAndPasteToLibrary($ImageName, $NewImageName,$SourceURL, $DestinationURL, $FolderMapping) 
{
	...
	$Image1200X800 	= str_replace(".","_1200_800.", $ImageName);
		...
		$ImageFolder1200X800   	= str_replace("original","w1200X800",$FolderMapping);
	 ...
	 // echo source_base_path . $SourceURL . $Image600X390. destination_base_path . $DestinationURL.$ImageFolder600X390 . $NewImageName;
	  ...
	  if (file_exists(source_base_path . $SourceURL . $Image900X450)){
	   ...
	   // Copy & Delete Image1200X800 Temp image //
	  if (file_exists(source_base_path . $SourceURL . $Image1200X800)){
		  if (copy(source_base_path . $SourceURL . $Image1200X800, destination_base_path . $DestinationURL.$ImageFolder1200X800. $NewImageName))
			unlink(source_base_path . $SourceURL .$Image1200X800);
			chmod(destination_base_path . $DestinationURL.$ImageFolder1200X800. $NewImageName, 0777);
	  }
...
function DeleteTempImage($TempName,$ImageId,$SourceURL) 
{
	...
	$Image1200X800 	= str_replace(".","_1200_800.", $TempName);
	$Image900X450 	= str_replace(".","_900_450.", $TempName);
...
function add_image_master($temp_image) {
	...
	function create_image_folder($year,$month,$date) {
			...
			if(!file_exists(destination_base_path.imagelibrary_image_path.$year."/".$month."/".$date)) {
				...
				mkdir(destination_base_path.imagelibrary_image_path.$year."/".$month."/".$date."/w1200X800",0777);
				chmod(destination_base_path.imagelibrary_image_path.$year."/".$month."/".$date."/w1200X800", 0777);
